...
const enUS: Translations = {
  ...
  "call.status.preparingCamera": "Preparing your camera...",
  "call.status.waitingParticipant": "Waiting for someone to join",
  "call.status.joining": "Joining call...",
  "call.status.connecting": "Connecting call...",
  ...
  "call.modal.title": "Share this call",
